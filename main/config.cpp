...
//------ right gate ------
//create gate object
gate gateRight(GPIO_K_OPEN_RIGHT, GPIO_K_CLOSE_RIGHT, GPIO_B_RIGHT_OPEN, GPIO_B_RIGHT_CLOSED, "gate_right", 1000, 2000, 10000);

//------ left gate ------
//create gate object
gate gateLeft(GPIO_K_OPEN_LEFT, GPIO_K_CLOSE_LEFT, GPIO_B_LEFT_OPEN, GPIO_B_LEFT_CLOSED, "gate_left", 1000, 2000, 10000);
