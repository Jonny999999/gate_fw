...
#define CONFIG_SW_G1_OPEN_GPIO      36  // Limit switch for Gate 1: Open (switch closed to GND (LOW) when gate is fully open)
#define CONFIG_SW_G1_CLOSED_GPIO    2   // Limit switch for Gate 1: Closed (switch OPEN (HIGH) when gate is fully closed)
#define CONFIG_SW_G2_OPEN_GPIO      5   // Limit switch for Gate 2: Open (switch closed to GND (LOW) when gate is fully open)
#define CONFIG_SW_G2_CLOSED_GPIO    18  // Limit switch for Gate 2: Closed (switch open (HIGH) when gate is fully closed)
...
#define CONFIG_LIGHTBARRIER_GPIO    39  // Light barrier input
...
//===== Output GPIO pins =====
//============================
#define CONFIG_SERVO_ENABLE_GPIO    12  // MOSFET Enable for Servo
#define CONFIG_LIGHTBARRIER_EN_GPIO 14  // MOSFET Enable for Light Barrier
#define CONFIG_LED_GPIO             13  // Status LED
#define CONFIG_BUZZER_GPIO          27  // Buzzer
#define CONFIG_RELAY_VFD1_GPIO      25  // Relay for VFD1
#define CONFIG_RELAY_VFD2_GPIO      26  // Relay for VFD2
#define CONFIG_SERVO_PWM_GPIO       33  // Servo PWM Signal
